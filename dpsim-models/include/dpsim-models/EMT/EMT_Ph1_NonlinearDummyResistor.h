...
namespace EMT {
namespace Ph1 {
/// EMT linear Resistor disguised as nonlinear
class NonlinearDummyResistor : public MNASimPowerComp<Real>,
                 public Base::Ph1::Resistor,
                 public MNANonlinearVariableCompInterface,
                 public SharedFactory<NonlinearDummyResistor> {
protected:
  Matrix mJacobian = Matrix::Zero(1, 1);

public:
  /// Defines UID, name, component parameters and logging level
  NonlinearDummyResistor(String uid, String name,
           Logger::Level logLevel = Logger::Level::off);
  /// Defines name, component parameters and logging level
  NonlinearDummyResistor(String name, Logger::Level logLevel = Logger::Level::off)
      : NonlinearDummyResistor(name, name, logLevel) {}
