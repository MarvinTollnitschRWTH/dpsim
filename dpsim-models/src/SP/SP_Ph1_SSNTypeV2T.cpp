...
void SP::Ph1::SSNTypeV2T::setParameters(const Matrix A, const Matrix B,
...
void CPS::SP::Ph1::SSNTypeV2T::setSSNMatricesToZero() {
  **mA = Matrix::Zero(1, 1);
  **mB = Matrix::Zero(1, 1);
  **mC = Matrix::Zero(1, 1);
  **mD = Matrix::Zero(1, 1);
...
void SP::Ph1::SSNTypeV2T::manualInit(Matrix initialState, Matrix initialInput,
...
// #### Tear Methods ####
void SP::Ph1::SSNTypeV2T::mnaTearApplyMatrixStamp(SparseMatrixRow &tearMatrix) {
